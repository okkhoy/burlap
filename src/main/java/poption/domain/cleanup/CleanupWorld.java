...
import poption.domain.cleanup.state.CleanupDoor;
...
public class CleanupWorld implements DomainGenerator {
	...
	public class InRegion extends PropositionalFunction {
		...
		public boolean isTrue(OOState s, String... params) {
			...
			if (o == null || region == null || o.get(ATT_X) == null || o.get(ATT_Y) == null) {
				return false;
			}
	...
	public Domain generateDomain() {
		...
		domain.addActionTypes(
				...
				new UniversalActionType(ACTION_PUSH),
...
//				new PullActionType(ACTION_PULL));
	...
	*/
	...
	public static void main(String[] args) {
		...
		Visualizer v = CleanupVisualizer.getVisualizer(width, height, null);
		...
		exp.addKeyAction("f", ACTION_PUSH, "");
		exp.addKeyAction("q", ACTION_TURN_LEFT, "");
		exp.addKeyAction("e", ACTION_TURN_RIGHT, "");
		exp.initGUI();
		exp.requestFocus();
